...
object NotarizeFSM {
  ...
  final case class NotarizeFiatSent(notaryUrl: URL, id: UUID) extends Command

  final case class NotarizeFiatNotSent(notaryUrl: URL, id: UUID) extends Command
