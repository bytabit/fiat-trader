...
case class CertifiedFiatNotSent(certifyFiatRequested: CertifyFiatEvidence,
  ...
  def unsignedPayoutTx: PayoutTx = certifyFiatRequested.unsignedFiatNotSentPayoutTx
