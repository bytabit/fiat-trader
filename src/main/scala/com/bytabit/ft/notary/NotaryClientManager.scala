...
import com.bytabit.ft.notary.NotaryClientFSM.AddSellOffer
import com.bytabit.ft.notary.NotaryClientManager._
...
import com.bytabit.ft.util.ListenerUpdater
...
class NotaryClientManager(walletMgr: ActorRef) extends PersistentActor with ListenerUpdater {
  ...
  override val receiveCommand: Receive = {
    ...
    case RemoveNotary(u: URL) =>
      // TODO return errors if notary in use for active trades
