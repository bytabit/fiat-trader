...
import com.bytabit.ft.fxui.model.TradeUIModel.{BUYER, Origin, SELLER}
import com.bytabit.ft.fxui.util.ActorFxService
import com.bytabit.ft.notary.NotaryClientFSM.{AddSellOffer, ContractAdded, ContractRemoved}
...
import com.bytabit.ft.wallet.model.Buyer
